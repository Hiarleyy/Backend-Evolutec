...
async function main() {
  // Clear existing data
  await prisma.leadEbook.deleteMany()
    ...
    data: [
      {
        ...
        objectives: ["Desenvolver atendimento humanizado", "Compreender rotinas de farmácia", "Apoiar organização de estoque"],
        curriculum: ["Introdução ao ambiente farmacêutico", "Noções de medicamentos", "Atendimento e vendas", "Boas práticas de organização"],
        careerOpportunities: ["Farmácias e drogarias", "Distribuidoras de medicamentos", "Estabelecimentos de saúde"],
        requirements: ["Ensino médio em andamento ou concluído", "Idade mínima de 16 anos"],
      ...
      },
      {
        ...
        objectives: ["Organizar rotinas administrativas", "Apoiar equipes e processos", "Trabalhar com documentação"],
        curriculum: ["Rotinas administrativas", "Comunicação profissional", "Pacote office", "Gestão de documentos"],
        careerOpportunities: ["Escritórios", "Lojas e centros de distribuição", "Empresas de serviços"],
        requirements: ["Ensino médio em andamento ou concluído"],
        certificationType: "Certificado de conclusão",
